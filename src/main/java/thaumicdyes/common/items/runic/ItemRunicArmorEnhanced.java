...
public class ItemRunicArmorEnhanced extends ItemRunicArmor implements IVisDiscountGear {
    ...
    public int getRunicCharge(ItemStack itemstack) {
        ...
        if (((itemstack.hasTagCompound()) && (itemstack.stackTagCompound.hasKey("upgrade"))
            ...
            || ((itemstack.hasTagCompound()) && (itemstack.stackTagCompound.hasKey("upgrade2"))
                && (itemstack.stackTagCompound.getInteger("upgrade2") == 2))) {
            if (((itemstack.hasTagCompound()) && (itemstack.stackTagCompound.hasKey("upgrade"))
                && (itemstack.stackTagCompound.getInteger("upgrade") == 2))
                && ((itemstack.hasTagCompound()) && (itemstack.stackTagCompound.hasKey("upgrade2"))
                    && (itemstack.stackTagCompound.getInteger("upgrade2") == 2))) {
                return (this.armorType == 0) ? 16 : ((this.armorType == 1) ? 48 : ((this.armorType == 2) ? 32 : 16)); // TODO
                                                                                                                      // 112
                                                                                                                      // total
            } else {
    ...
    public void addInformation(ItemStack stack, EntityPlayer player, List list, boolean par4) {
        ...
        // list.add(EnumChatFormatting.DARK_PURPLE + StatCollector.translateToLocal("tc.visdiscount") + " ("+tag+"): " +
        // getVisDiscount(stack, player, aspect) + "%");
        // }
        // }
    }
