...
public class ThaumiumFortressDyed extends ItemFortressArmor
    ...
    public void registerIcons(IIconRegister ir) {
        this.iconHelmOver = ir.registerIcon("thaumicdyes:icon/fortress_helm");
        this.iconChestOver = ir.registerIcon("thaumicdyes:icon/fortress_chest");
        this.iconLegsOver = ir.registerIcon("thaumicdyes:icon/fortress_legs");
