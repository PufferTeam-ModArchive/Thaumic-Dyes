...
public class CultistKnightDyed extends ItemArmor implements IRepairable, IRunicArmor/* , ISpecialArmor */ {
    ...
    public void registerIcons(IIconRegister ir) {
        this.iconHelm = ir.registerIcon("thaumicdyes:icon/cultist_plate_helm");//
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, int slot, String type) {
        return type == null ? "thaumicdyes:textures/models/cultist_knight_overlay.png"
            : "thaumicdyes:textures/models/cultist_knight_base.png";
    }
