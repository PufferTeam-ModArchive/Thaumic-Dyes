...
public class CultistPraetorDyed extends ItemArmor
    implements IRepairable, IRunicArmor, IVisDiscountGear/* , ISpecialArmor */ {
    ...
    public void registerIcons(IIconRegister ir) {
        this.iconHelm = ir.registerIcon("thaumicdyes:icon/cultist_leader_helm");
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, int slot, String type) {
        return type == null ? "thaumicdyes:textures/models/cultist_praetor_overlay.png"
            : "thaumicdyes:textures/models/cultist_praetor_base.png";
    }
    ...
    public ModelBiped getArmorModel(EntityLivingBase entityLiving, ItemStack itemStack, int armorSlot) {
        ...
        if (this.model1 == null) {
            this.model1 = new ModelPraetor(1.0F);
        }

        if (this.model2 == null) {
            this.model2 = new ModelPraetor(0.5F);
        }
