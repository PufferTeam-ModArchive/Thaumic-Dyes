...
public class CultistArcherDyed extends ItemArmor implements IRepairable, IRunicArmor/* , ISpecialArmor */ {
    ...
    public CultistArcherDyed(ArmorMaterial enumarmormaterial, int j, int k) {
    ...
    public void registerIcons(IIconRegister ir) {
        this.iconHelmOver = ir.registerIcon("thaumicdyes:icon/cultist_archer_helm");
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, int slot, String type) {
        return type == null ? "thaumicdyes:textures/models/cultist_archer_overlay.png"
            : "thaumicdyes:textures/models/cultist_archer_base.png";
    }// replace
