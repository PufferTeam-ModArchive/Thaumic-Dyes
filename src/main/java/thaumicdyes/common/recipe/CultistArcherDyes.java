...
import thaumicdyes.common.items.CultistArcherDyed;

public class CultistArcherDyes implements IRecipe {
        ...
        for (int i = 0; i < par1InventoryCrafting.getSizeInventory(); ++i) {
            ...
            if (itemstack1 != null) {
                if (itemstack1.getItem() instanceof ItemArmor) {
                    ...
                    if (!(itemarmor instanceof CultistArcherDyed) || itemstack != null) {
                        return false;
                    }
