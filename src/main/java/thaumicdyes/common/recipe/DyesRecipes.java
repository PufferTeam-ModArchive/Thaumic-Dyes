...
public class DyesRecipes {
    ...
    public static void initRecipes() {
        ...
        RecipeSorter.register(
            "forge:shapelessorenbt",
            ShapelessNBTOreRecipe.class,
            RecipeSorter.Category.SHAPELESS,
            "after:forge:shapelessore");
        RecipeSorter
            .register("forge:TDrobearmordye", CultistRobeDyes.class, Category.SHAPELESS, "after:forge:shapelessorenbt");
        RecipeSorter
            .register("forge:TDfortressarmordye", FortressDyes.class, Category.SHAPELESS, "after:forge:TDrobearmordye");
        RecipeSorter.register(
            "forge:TDpraetorarmordye",
            CultistPraetorDyes.class,
            Category.SHAPELESS,
            "after:forge:TDrobearmordye");
        RecipeSorter.register(
            "forge:TDknightarmordye",
            CultistKnightDyes.class,
            Category.SHAPELESS,
            "after:forge:TDrobearmordye");
        RecipeSorter.register(
            "forge:TDrangerarmordye",
            CultistRangerDyes.class,
            Category.SHAPELESS,
            "after:forge:TDrobearmordye");
        RecipeSorter
            .register("forge:TDvoidrobearmordye", VoidRobeDyes.class, Category.SHAPELESS, "after:forge:TDrobearmordye");
        RecipeSorter.register(
            "forge:TDthaumiumrobearmordye",
            ThaumiumRobeDyes.class,
            Category.SHAPELESS,
            "after:forge:TDrobearmordye");
        RecipeSorter.register(
            "forge:TDarcherarmordye",
            CultistArcherDyes.class,
            Category.SHAPELESS,
            "after:forge:TDrobearmordye");
    }
    ...
    public static void initInfusionRecipes() {
        ...
        ConfigResearch.recipes.put(
            "HelmGoggles", // ?src: new NBTTagByte(1)
        ...
        ConfigResearch.recipes.put(
            ...
            ThaumcraftApi.addInfusionCraftingRecipe(
                ...
                new ItemStack[] { new ItemStack(Items.dye, 1, 0), new ItemStack(Items.iron_ingot),
                    new ItemStack(Items.leather), ItemApi.getBlock("blockCustomPlant", 2),
                    ItemApi.getItem("itemZombieBrain", 0), new ItemStack(Items.iron_ingot) }));
