...
public class ModelRobesSpecial extends ModelBiped {
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
        ...
        // this.ClothBackR2.rotateAngleX = (this.ClothBackL2.rotateAngleX = this.ClothBackR3.rotateAngleX =
        // this.ClothBackL3.rotateAngleX = -c + 0.2268928F);
        ...
        // this.Cloak3.rotateAngleX = (MathHelper.sin((entity.ticksExisted + this.partialTicks - 10.0F) / 7.0F) *
        // 0.12F);
